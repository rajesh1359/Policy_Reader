...
policy_map = {
    ...
    "TW_TP": "Two Wheeler Liability",
    "TW_SOD": "Two Wheeler Policy Standalone OD",
...
class HDFC:
    ...
    def get_policy_type(self):
        ...
        vehicle_type = None
        policytype = None
        POI = self.get_POI('.*proposal\s*form\s*cum*')
    ...
    def get_policy_number(self):
        ...
        text_box_content = ""
        text_box_content = POI.get_textbox([s1[0].x0, s1[0].y0, 9999, s1[0].y1])
    ...
    def get_registration_number(self):
        ...
        text_box_content = POI.get_textbox([s1[0].x0, s1[0].y0, s_temp3[0].x0, s1[0].y1])
    ...
    def get_make(self):
        ...
        s1 = self.get_xy(poi=POI, text='Make',
                         clip=[s_temp2[0].x0, s_temp1[0].y1, s_temp3[0].x0, s_temp2[0].y1])
        # print(s1)
        text_box_content = POI.get_textbox([s1[0].x0, s1[0].y0, 9999, s1[0].y1+10])
    ...
    def get_expiry(self):
        ...
        text_box_content = POI.get_textbox([s_temp2[0].x0, s_temp3[0].y1, 9999, s_temp2[0].y1])
        #print(text_box_content)
        pattern = ".*To(.*)Midnight.*"
    ...
    def get_net_amount(self):
        POI = self.get_POI('.*policy details.*')
        tp_dict = self.get_price(".*net\s*liability\s*premium.*",POI)
    ...
    def get_code(self):
        POI = self.get_POI('.*proposal\s*details.*')
